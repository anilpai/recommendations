...
const data = {
  "1": [
    {
      auto_optimizer_id: "1",
      auto_optimizer_explanation:
        "People in Austin, Boulder and Portland tend to click your ad more often than people in other cities. Consider confining your campaign to these regions."
    },
    {
      auto_optimizer_id: "2",
      auto_optimizer_explanation:
        "Ads for this campaign perform particularly poorly in Houston, consider excluding it from your advertising campaign."
    }
  ]
};

export default class CampaignGeoRecommendationService {
  ...
  static dismissRecommendation(campaignId, recommendationId) {
    return MockServer.request(() => {
      ...
      data[campaignId] = recommendations.filter((recommendation) => {
        return recommendation.auto_optimizer_id !== recommendationId;
      });
