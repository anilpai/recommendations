  ...
  "1": [
    {
      id: "1",
      text:
        "You should consider increasing your daily budget in order to spend your total budget by the campaign's end.",
      username: "Abby"
    },
    {
      id: "2",
      text:
        'Turn the "Pace Evenly" feature on in order to spread your advertisement purchasing out over the course of the day.',
      username: "Ted"
    }
  ]
};
