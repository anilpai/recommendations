...
export default class AdFormatTargeting extends React.Component {
  ...
  initialLoad() {
    ...
    const getAllAdFormatsPromise = AdFormatService.getAllAvailableAdFormats(this.props.campaignId).then(
      (allAdFormats) => {
        this.setState({
    ...
    const getAllSelectedAdFormatsPromise = CampaignService.getSelectedAdFormatIds(this.props.campaignId).then(
      (selectedIds) => {
        this.setState({
    ...
    CancelOnUnmount.track(
      this,
      Promise.all([getAllAdFormatsPromise, getAllSelectedAdFormatsPromise]).catch(() => {
        this.setState({
          isError: true,
  ...
  handleSaveButtonClicked() {
    ...
    CancelOnUnmount.track(
      this,
      CampaignService.saveSelectedAdFormatIds(this.props.campaignId, this.state.selectedAdFormatIds)
        .catch(() => {
          this.setState({
            isError: true,
