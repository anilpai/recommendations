...
export default class GeoTargeting extends React.Component {
  ...
  constructor(props) {
    ...
    this.handleGeoSearchGetResults = this.debounce(this.handleGeoSearchGetResults.bind(this), 500);
  ...
  handleGeoSearchChanged(newSearch) {
    ...
    this.handleGeoSearchGetResults(newSearch);
  }

  handleGeoSearchGetResults(newSearch){
  ...
  handleSaveButtonClicked() {
    ...
    CancelOnUnmount.track(
      this,
      CampaignService.saveSelectedGeoIds(this.props.campaignId, this.state.selectedGeoIds)
        .catch(() => {
          this.setState({
            isError: true,
