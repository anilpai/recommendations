...
export default class MyApplication extends React.Component {
  ...
  getTabClassName(thisTab) {
    if (thisTab === this.state.selectedTab) return "tab selected";
    return "tab";
  }
    ...
    return (
      <div className="myapplication">
        <div className="header">
          <img src="../../assets/ttd-logo-white.png" />
        </div>
        <div className="content">
          ...
          <div className="body">{this.renderSelectedTabContents(this.state.selectedTab)}</div>
        </div>
      </div>
    );
  }
